...
func TestFieldByFieldComparison(t *testing.T) {
	...
	t.Run("Summary", func(t *testing.T) {
		// Calculate full state hashes
		fastFullHash, _ := fastState.HashTreeRoot()
		ourFullHash, _ := flexssz.HashTreeRoot(ourState)
		
		t.Logf("=== FULL STATE HASHES ===")
		t.Logf("fastssz: 0x%x", fastFullHash)
		t.Logf("flexssz: 0x%x", ourFullHash)
		t.Logf("Match: %v", fastFullHash == ourFullHash)
		
		if fastFullHash != ourFullHash {
			t.Logf("Expected (fastssz): 0xc4a9c5ebf637c089db599574b568bb679b385c1984f08410707db08e03d7ae52")
			t.Logf("Got (flexssz):      0x25bab03501b4b5e1255381d0e55a8764ec7b0e861df449166e4c7674ff498779")
		}
	})
}
